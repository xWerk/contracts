...
/// @notice Deploys at deterministic addresses across chains the {WerkSubdomainRegistrar} contract
/// @dev Reverts if any contract has already been deployed
contract DeployDeterministicWerkSubdomainRegistrar is BaseScript {
        ...
        returns (WerkSubdomainRegistrar subdomainRegistrar)
    {
        ...
        subdomainRegistrar = new WerkSubdomainRegistrar{ salt: salt }(registry, DEFAULT_PROTOCOL_OWNER);
    }
}
